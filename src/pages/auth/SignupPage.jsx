            ...
            <div className="flex-1 flex flex-col items-center justify-center p-8 lg:p-16 bg-white relative">
                <div className="w-full max-w-[380px] animate-in fade-in zoom-in-95 duration-500">
                    ...
                    <div className="mb-10 text-left">
                        ...
                        <p className="text-neutral-500 mt-2 text-[15px] font-medium">Choose how you want to sign up</p>
                    </div>
                    ...
                    <form onSubmit={handleSignup} className="space-y-5">
                        <div className="space-y-2.5">
                            <label className="text-[12px] font-bold text-neutral-700 tracking-wide">Full Name</label>
                            <Input
                                type="text"
                    ...
                    <div className="mt-10 text-left text-[14px] font-medium text-neutral-500">
                        ...
                        <Link to="/login" className="text-indigo-600 hover:text-indigo-700 font-bold hover:underline underline-offset-4">
                            Sign in
                        </Link>
                    </div>
                </div>
